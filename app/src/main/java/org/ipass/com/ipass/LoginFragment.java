...
/**
 * Created by Abishek on 11-Apr-18.
 */
...
//                Toast.makeText(getContext(),pass, Toast.LENGTH_SHORT).show();
                ...
                if (mail.matches("[a-zA-Z0-9._-]+@[a-z]+.[a-z]+") && !pass.equals("") && pass.length()>=6 ){
                    //HTTP request
                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (response != null)
                                    {
                                        try {
                                            ...
                                            Bean bean =new Bean();
                                            bean.setApi(jsonObject.getString("apiKey"));
                                            ...
                                            Intent intent =new Intent(getActivity(),PrivateNavigation.class);
